...
def levels(request):
	...
	return render(request, 'music/levels.html')
...
def easy(request):
	...
	if request.method == 'GET':
		...
		return render(request, 'music/questions_level.html', context)
...
def submit(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			if request.session['undergo_test'] == 'Easy':
				...
				try:	
					new_score = RankingMusic.objects.create(
	...
	return render(request, 'music/add_score.html', {'form': form})
